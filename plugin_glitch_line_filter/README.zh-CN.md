...
> [!success] 2026-07-17 · 新增
> 完成中文使用说明。本文件作为插件的中文 README，技术内容同步维护到 Obsidian 插件笔记。

> [!example] 2026-07-17 · 验收
> 已在 TouchDesigner 2023.11280 中读取并核对单 TOP 输入/输出、5 个预设、全部公开参数和 4 种调试视图。当前测试输出为 `1280 × 720`、8-bit RGBA，GLSL 无错误或警告。
